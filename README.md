...
This figure compares three scenario with different adult fertility rates, falling by 1% per year (blue), steady (green), and rising by 1% per year (red). When we include children in the number of people that workers must support we find that when fertility rates decline workers support fewer people altogether.
